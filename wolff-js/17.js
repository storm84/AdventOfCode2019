...
async function calc(programInput, program) {
  ...
  // map.moveTo(36, 16);
  // console.log(map.get(36, 16));

  // while (true) {
  //   const { x, y } = dirs[dirIndex];

  //   let count = 0;

  //   for (; map.get() !== "." && map.get() !== undefined; count++) {
  //     map.move(x, y);
  //   }
  ...
  //   const leftDir = dirs[(dirIndex + 1) % 4];

  //   // left
  //   map.move(leftDir.x, leftDir.y);
  //   const leftSymbol = map.get();
  //   // right
  //   map.move(-leftDir.x * 2, -leftDir.y * 2);
  //   const rightSymbol = map.get();
  //   // reset
  //   map.move(leftDir.x, leftDir.y);
